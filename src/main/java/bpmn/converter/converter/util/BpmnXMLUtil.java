package bpmn.converter.converter.util;
...
import bpmn.converter.converter.child.ActivitiEventListenerParser;
import bpmn.converter.converter.child.ActivitiFailedjobRetryParser;
import bpmn.converter.converter.child.ActivitiMapExceptionParser;
import bpmn.converter.converter.child.BaseChildElementParser;
import bpmn.converter.converter.child.CancelEventDefinitionParser;
import bpmn.converter.converter.child.CompensateEventDefinitionParser;
import bpmn.converter.converter.child.ConditionExpressionParser;
import bpmn.converter.converter.child.DataInputAssociationParser;
import bpmn.converter.converter.child.DataOutputAssociationParser;
import bpmn.converter.converter.child.DataStateParser;
import bpmn.converter.converter.child.DocumentationParser;
import bpmn.converter.converter.child.ErrorEventDefinitionParser;
import bpmn.converter.converter.child.ExecutionListenerParser;
import bpmn.converter.converter.child.FieldExtensionParser;
import bpmn.converter.converter.child.FlowNodeRefParser;
import bpmn.converter.converter.child.FormPropertyParser;
import bpmn.converter.converter.child.IOSpecificationParser;
import bpmn.converter.converter.child.MessageEventDefinitionParser;
import bpmn.converter.converter.child.MultiInstanceParser;
import bpmn.converter.converter.child.SignalEventDefinitionParser;
import bpmn.converter.converter.child.TaskListenerParser;
import bpmn.converter.converter.child.TerminateEventDefinitionParser;
import bpmn.converter.converter.child.TimeCycleParser;
import bpmn.converter.converter.child.TimeDateParser;
import bpmn.converter.converter.child.TimeDurationParser;
import bpmn.converter.converter.child.TimerEventDefinitionParser;
import bpmn.model.BaseElement;
import bpmn.model.BpmnModel;
import bpmn.model.ExtensionAttribute;
import bpmn.model.ExtensionElement;
